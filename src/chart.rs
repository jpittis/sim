...
use plotly::layout::{Axis, Layout, RangeMode};
use plotly::{Plot, Scatter};

pub fn chart_amplification(with: Vec<f64>, without: Vec<f64>) -> anyhow::Result<()> {
    ...
    let layout = Layout::new()
        ...
        .y_axis(Axis::new().title(Title::new("Amplification")));
